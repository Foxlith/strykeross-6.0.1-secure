...
.method public static getImageDimensions(Landroid/content/Context;I)Lg0/c;
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lg0/c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string v0, "Failed to decode image resource with id "
...
.method public static getImageDimensions(Ljava/io/File;)Lg0/c;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v0}, Lg0/c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static getSampleSize(Lg0/c;II)I
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static loadThumbnail(Landroid/content/Context;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lde/mrapp/android/util/BitmapUtil;->getImageDimensions(Landroid/content/Context;I)Lg0/c;

    move-result-object v0

    invoke-static {v0, p2, p3}, Lde/mrapp/android/util/BitmapUtil;->getSampleSize(Lg0/c;II)I
    ...
    const-string p2, "Failed to decode image resource with id "
...
.method public static loadThumbnail(Ljava/io/File;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lde/mrapp/android/util/BitmapUtil;->getImageDimensions(Ljava/io/File;)Lg0/c;

    move-result-object v0

    invoke-static {v0, p1, p2}, Lde/mrapp/android/util/BitmapUtil;->getSampleSize(Lg0/c;II)I
    ...
    .line 7
    invoke-static {p2, p0, v0}, Lorg/bouncycastle/math/ec/a;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static splitHorizontally(Landroid/graphics/Bitmap;)Lg0/c;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Lde/mrapp/android/util/BitmapUtil;->splitHorizontally(Landroid/graphics/Bitmap;I)Lg0/c;
...
.method public static splitHorizontally(Landroid/graphics/Bitmap;I)Lg0/c;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v0, p0}, Lg0/c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object p1
.end method

.method public static splitVertically(Landroid/graphics/Bitmap;)Lg0/c;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Lde/mrapp/android/util/BitmapUtil;->splitVertically(Landroid/graphics/Bitmap;I)Lg0/c;
...
.method public static splitVertically(Landroid/graphics/Bitmap;I)Lg0/c;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
