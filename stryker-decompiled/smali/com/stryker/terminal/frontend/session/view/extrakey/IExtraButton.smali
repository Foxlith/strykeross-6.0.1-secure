.class public abstract Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton$Companion;
    }
.end annotation


# static fields
.field public static final Companion:Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton$Companion;
...
# instance fields
.field private buttonKeys:Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton$Companion;-><init>(Lkotlin/jvm/internal/f;)V

    sput-object v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->Companion:Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton$Companion;

    const/4 v0, -0x1

    sput v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->NORMAL_TEXT_COLOR:I

    const v0, -0x7f2116

    sput v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->SELECTED_TEXT_COLOR:I
...
.method public static final synthetic access$getNORMAL_TEXT_COLOR$cp()I
    ...
    sget v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->NORMAL_TEXT_COLOR:I
...
.method public static final synthetic access$getSELECTED_TEXT_COLOR$cp()I
    ...
    sget v0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->SELECTED_TEXT_COLOR:I
...
.method public static final synthetic access$setNORMAL_TEXT_COLOR$cp(I)V
    ...
    sput p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->NORMAL_TEXT_COLOR:I
...
.method public static final synthetic access$setSELECTED_TEXT_COLOR$cp(I)V
    ...
    sput p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->SELECTED_TEXT_COLOR:I
...
# virtual methods
.method public final getButtonKeys()Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;
    .locals 1

    iget-object v0, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->buttonKeys:Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;
...
.method public final getDisplayText()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->displayText:Ljava/lang/String;
...
.method public final setButtonKeys(Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;)V
    .locals 0

    iput-object p1, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->buttonKeys:Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;
...
.method public final setDisplayText(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->displayText:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->displayText:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/stryker/terminal/frontend/session/view/extrakey/IExtraButton;->buttonKeys:Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/stryker/terminal/frontend/session/view/extrakey/CombinedSequence;->getKeys()Ljava/util/List;
