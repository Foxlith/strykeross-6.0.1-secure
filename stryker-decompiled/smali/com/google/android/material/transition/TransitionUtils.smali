...
.method public static findAncestorById(Landroid/view/View;I)Landroid/view/View;
    ...
    .line 32
    .line 33
    invoke-static {v0, p1}, Lo/i;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static maybeAddTransition(Landroidx/transition/a0;Landroidx/transition/u;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/a0;->e(Landroidx/transition/u;)V

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(Landroidx/transition/u;Landroid/content/Context;I)Z
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/transition/u;->setDuration(J)Landroidx/transition/u;
...
.method public static maybeApplyThemeInterpolator(Landroidx/transition/u;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/u;->setInterpolator(Landroid/animation/TimeInterpolator;)Landroidx/transition/u;
...
.method public static maybeApplyThemePath(Landroidx/transition/u;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Landroidx/transition/n;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/u;->setPathMotion(Landroidx/transition/n;)V
...
.method public static maybeRemoveTransition(Landroidx/transition/a0;Landroidx/transition/u;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/a0;->f(Landroidx/transition/u;)V

    :cond_0
    return-void
.end method

.method public static resolveThemePath(Landroid/content/Context;I)Landroidx/transition/n;
    .locals 3
    ...
    .line 58
    new-instance p1, Landroidx/transition/o;

    .line 59
    .line 60
    invoke-static {p0}, Lv1/f;->r(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    .line 64
    invoke-direct {p1, p0}, Landroidx/transition/o;-><init>(Landroid/graphics/Path;)V
